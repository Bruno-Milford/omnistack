// GET: Buscar ou listar usuários
// POst: Cria alguma nova informaçaõ
// PUT: Atualizar uma informação existente
// DELETE: Deletar uma informação existente

// Tres tipos de parametros
// Corpo (Resquest Body): Dados para a criação ou atualização de um registro
    ...
    async create (request: Request, reponse: Response) {
        ...
        try {
            ...
            return reponse.status(400).json({
                error: 'Unexpected error while creating new class' // Erro inesperado ao criar nova classe
            })
        }
    }
}